...
.ant-menu-submenu-inline > .ant-menu-submenu-title .ant-menu-submenu-arrow::after {
  ...
  background: #fff;
  background: #141446 \9;
  background-image: -webkit-gradient(linear, left top, right top, from(#141446), to(#141446));
  background-image: linear-gradient(to right, #141446, #141446);
...
.ant-menu-submenu-inline > .ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before {
  background: -webkit-gradient(linear, left top, right top, from(#7A77FF), to(#7A77FF));
  background: linear-gradient(to right, #7A77FF, #7A77FF);
}
.ant-menu-submenu-inline > .ant-menu-submenu-title .ant-menu-submenu-arrow::before {
