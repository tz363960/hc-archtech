...
module.exports = (function () {
     ...
     * 这一步很奇怪，如果事先登录过，就不再调用以下这个函数
     * @return Promise
     */
    OAuth2TwoLegged.prototype.authenticate = function () {  // 这一步得到token,如果事先登录过，就不再调用这个函数
        var _this = this;
        return new Promise(function(resolve, reject) {
            if (_this.authentication && _this.authentication.tokenUrl) {
                ...
                _this.doPostRequest(url, body, function(response){  // 未找到doPostRequest的定义？
